...
```
Agent(
  prompt="Read C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/gsd-core/templates/SECURITY.md`
