...
- **Global scope**: `C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/notes/`)
...
2. Glob `C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/notes/` — works in any directory
