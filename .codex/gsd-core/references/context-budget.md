...
The keys live in `.codex/settings.json` (project) or `C:/Users/Admin/OneDrive/Documents/New folder/Verify My Interview/.codex/settings.json` (global) — **not** in `.planning/config.json`:
